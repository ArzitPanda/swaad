	...
	<div class="container flex justify-between h-16 mx-auto">
		<div class="flex">
			...
			<ul class="items-stretch hidden space-x-3 lg:flex ">
				...
				<li class="flex">
					<a rel="noopener noreferrer" href="order.php" class="flex items-center px-4 -mb-1 border-b-2 border-transparent hover:text-violet-400 hover:border-violet-400">order</a>
				</li>
				<li class="flex">
		...
		<div class="items-center flex-shrink-0 hidden lg:flex">
			...
			<button class="px-8 py-3 font-semibold rounded bg-violet-400 text-gray-900"><?php if($_SESSION['user'] != NULL){echo 'Logout';} else {echo 'Login/signup';}?></button>
            </a>  
		</div>
